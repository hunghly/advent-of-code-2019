(function () {
    ...
    let calculateParameters = function (opCode, firstVar, secondVar, firstParamMode, secondParamMode, intCodeInputArray, currentIndex) {
        ...
        if (opCode === "1") {
            outputPos = intCodeInputArray[currentIndex + 3];
            if (firstParamMode === "0" && secondParamMode === "0") {
                ...
                console.log(`For opCode ${opCode}, firstParam ${firstParamMode} and secondParam ${secondParamMode}, my total is ${Number(total)} outputted at position ${outputPos}`);
        ...
        // Opcode 3, so ask for input
            ...
            intCodeInputArray[outputPos] = Number(total);
            console.log(`For opCode ${opCode}, my input is ${Number(total)} outputted at position ${outputPos}`);
            total = "0";
        }
        // Opcode 4, just output the value at parameter location
        else if (opCode === "4") {
            outputPos = intCodeInputArray[currentIndex + 1];
            console.log(`If returns 0 for outputPos ${outputPos}, then debug is correct: ${intCodeInputArray[outputPos]}.-----------------------------------------------`);
            total = "0";
        }
    ...
    let correctProgram = function (intCodeInputArray) {
        ...
        while (intCodeInputArray[currentIndex] !== 99) {
            ...
            opCodeString = intCodeInputArray[currentIndex].toString().padStart(5, "0");
            ...
            */
            ...
            // OpCode is 01
            firstVar = intCodeInputArray[currentIndex + 1];
            secondVar = intCodeInputArray[currentIndex + 2];
            console.log(`For opCode String: ${opCodeString} and opCode: ${opCode}, my firstVar is ${firstVar} and my secondVar is ${secondVar} and currentIndex: ${currentIndex}.`);
            // Calculate
            output += Number(calculateParameters(opCode, firstVar, secondVar, firstParamMode, secondParamMode, intCodeInputArray, currentIndex));
            console.log(intCodeInputArray);
    ...
    */
    ...
    /*    let testArray12 = [3,15,1,12,6,6,1100,1,238,225,104,0,1101,61,45,225,102,94,66,224,101,-3854,224,224,4,224,102, 99];
        console.log("Final Output: " + correctProgram(testArray12));
        console.log(intCodeArray[225]);*/

    console.log("Final Output: " + correctProgram(intCodeArray));
})();