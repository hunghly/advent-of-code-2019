(function () {
    ...
    let correctProgram = function (intCodeInputArray) {
        ...
        for (let i = 0; i < 1; i++) {
            ...
            twoDigitOpCode = opCodeString.slice(opCodeString.length - 2);
